                ...
                <div class="container mx-auto px-4 py-10 flex flex-col lg:flex-row">
                    <div class="lg:w-1/2 z-10 pr-4 opcoes-home">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div
                                    class="bg-white rounded-lg items-center hover:shadow-lg transition-shadow transform hover:translate-x-1">
                            ...
                            <div class="bg-red-400 bg-opacity-30 rounded-lg p-6 patro-img">
                                <div class="flex justify-around">
                                    <a href="https://webcrumbs.cloud/placeholder"
                                        class="text-white flex flex-col items-center hover:opacity-80 transition-opacity">

                                        <img src="../img/patro-home-pets.png" alt="AcheiPet"
                                            class="h-10 mr-2 hover:opacity-80 transition-opacity" />
                                    </a>
                                    <a href="https://webcrumbs.cloud/placeholder"
                                        class="text-white flex flex-col items-center hover:opacity-80 transition-opacity">
                                        <img src="../img/patro-petcare.png" alt="AcheiPet"
                                            class="h-10 mr-2 hover:opacity-80 transition-opacity" />
                                    </a>
                                    <a href="https://webcrumbs.cloud/placeholder"
                                        class="text-white flex flex-col items-center hover:opacity-80 transition-opacity">
                                        <img src="../img/patro-parrot.png" alt="AcheiPet"
                                            class="h-10 mr-2 hover:opacity-80 transition-opacity" />
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="lg:w-1/2 mt-6 lg:mt-0 flex justify-center lg:justify-end img-inicial">
                        <img src="../img/mulher_capao.png" alt="Woman with puppy"
