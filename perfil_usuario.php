...
<body>
    ...
    <div class="card p-4 shadow-sm " style="width: 50%;">
        <div class="row">
            <div class="col">
               <img  class="img-thumbnail" src="<?php echo htmlspecialchars($usuario["foto"]); ?>" alt="Foto do Usuário">
                </div>
            <div class="col">
            ...
            <p><b>CPF:</b> <?php echo htmlspecialchars($usuario["cpf"]); ?></samll></p> 
            <p><span class="badge bg-success"><?php echo htmlspecialchars($usuario["tipo_usuario"]); ?></span></p>
            </div>
        </div>
    </div>
    </div>
