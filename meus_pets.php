...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="mt-6 flex justify-center space-x-4">
            <a href="cadastrar_pet.php"
                class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Cadastrar Pet para
                Doação</a>
            <a href="cadastrar_pet_perdido.php"
                class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">Cadastrar Pet
                Perdido</a>
            <a href="perfil_usuario.php"
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Voltar ao Perfil</a>
        </div>
    </div>
