                        ...
                        <div id="listarpet">
                            ...
                            try {
                                ...
                                if (count($pets) > 0) {
                                    ...
                                    foreach ($pets as $pet) {
                                        echo "<tr>";
                                        echo "<td class='align-middle'>" . $pet["id_pet"] . "</td>";
                                        echo "<td class='align-middle'>" . $pet["nome"] . "</td>";
                                        echo "<td class='align-middle'>" . $pet["especie"] . "</td>";
                                        echo "<td class='align-middle'>" . $pet["raca"] . "</td>";
                                        echo "<td class='align-middle'>" . $pet["idade"] . "</td>";
                                        echo "<td class='align-middle'>" . $pet["porte"] . "</td>";
                                        echo "<td class='align-middle'>" . $pet["genero"] . "</td>";
                                        echo "<td class='align-middle'>" . $pet["numero_contato"] . "</td>";
                                        echo "<td class='align-middle'>" . $pet["status"] . "</td>";
                                        echo "<td class='align-middle'>";
                                        $caminho_foto = $pet["foto"];
                                        if (file_exists($caminho_foto)) {
                                            echo "<img class='fotopet' src='" . $caminho_foto . "' alt='Foto do Pet'>";
                                        } else {
                                            echo "Arquivo de imagem não encontrado: " . $caminho_foto; 
                                        }
                                        echo "</td>";
                                        echo "<td class='align-middle'><div class='d-flex justify-content-center align-items-center'>
                                    <button type='button' class='btn btn-primary me-2'>Adotar</button>
                                  </div></td>";
                                        echo "</tr>";
                                    }
                                    echo "</table>";
