...
define('SHEEP_URL', 'localhost/achei_pet/gerador-boleto');//ou dominio exemplo: maykonsilveira.com.br
define('SHEEP_HOST','localhost');
define('SHEEP_USER','tais');
define('SHEEP_SENHA','@llSans612');
define('SHEEP_BD','achei_pet');
