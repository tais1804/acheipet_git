...
<header class="py-4 px-6 flex items-center justify-between menu-topo">
    <div class="flex items-center">
        <a href="index.php" class="flex items-center">
            <img src="../img/logo.png" alt="AcheiPet" class="h-10 mr-2 hover:opacity-80 transition-opacity" />
        </a>
        <nav class="ml-6 hidden md:flex">
            <ul class="flex space-x-6">
                ...
                <li>
                    <a href="listar_pet_perdido.php" class="text-red-500 hover:text-red-600 transition-colors">Achei um
                        pet</a>
                </li>
                <li>
                ...
                <li>
                    <a href="mapa_veterinarios.php"
                        class="text-red-500 hover:text-red-600 transition-colors">Veterinários</a>
                </li>
                <li>
    ...
    <div class="flex items-center space-x-4">
        <button onclick="window.location.href='carrinho.php'"
            class="text-gray-700 hover:text-gray-900 transition-colors carrinho">
            <span
                class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center cont-itens"><?php echo $total_itens_carrinho; ?></span>
        ...
        <div class="relative, foto-home dropdown">
            <img src="<?php echo htmlspecialchars($usuario["foto"]); ?>" data-bs-toggle="dropdown" alt="Profile"
                class=" dropdown-toggle h-10 w-10 rounded-full object-cover border-2 border-red-500 hover:border-red-600 transition-all transform hover:scale-105" />
            <ul class="dropdown-menu">
                <li class="dropdown-item"> <a href="perfil_usuario.php">
